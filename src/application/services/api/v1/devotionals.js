...
export default createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(index.fulfilled, (state, action) => {
      state.loading = false;
      state.devotionals = action.payload.data;
      state.error = null;
    })
    ...
    builder.addCase(create.fulfilled, (state, action) => {
      ...
      state.devotionals.push(action.payload.data);
    ...
    builder.addCase(show.fulfilled, (state, action) => {
      ...
      state.devotional = action.payload.data;
    ...
    builder.addCase(update.fulfilled, (state, action) => {
      ...
      state.devotional = action.payload.data;
      const devotionalIndex = state.devotionals.findIndex((p) => p.id === action.payload.data.id)
      state.devotionals = state.devotionals.filter((p) => p.id !== action.payload.data.id)
      state.devotionals.splice(devotionalIndex, 0, action.payload.data)
