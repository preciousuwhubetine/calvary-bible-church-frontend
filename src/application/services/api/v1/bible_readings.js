...
export default createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(index.pending, (state) => {
      state.loading = true;
      state.bible_readings = [];
    })

    builder.addCase(index.fulfilled, (state, action) => {
      state.loading = false;
      state.bible_readings = action.payload.data;
      state.error = null;
    })
    ...
    builder.addCase(create.fulfilled, (state, action) => {
      ...
      state.bible_readings.push(action.payload.data);
    ...
    builder.addCase(show.fulfilled, (state, action) => {
      ...
      state.bible_reading = action.payload.data;
    ...
    builder.addCase(update.fulfilled, (state, action) => {
      ...
      state.bible_reading = action.payload.data;
      const bible_readingIndex = state.bible_readings.findIndex((p) => p.id === action.payload.data.id)
      state.bible_readings = state.bible_readings.filter((p) => p.id !== action.payload.data.id)
      state.bible_readings.splice(bible_readingIndex, 0, action.payload.data)
