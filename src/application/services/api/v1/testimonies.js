...
export default createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(create.fulfilled, (state, action) => {
      ...
      state.testimonies.push(action.payload.data);
    ...
    builder.addCase(show.fulfilled, (state, action) => {
      ...
      state.testimony = action.payload.data;
    ...
    builder.addCase(update.fulfilled, (state, action) => {
      ...
      state.testimony = action.payload.data;
      const testimonyIndex = state.testimonies.findIndex((p) => p.id === action.payload.data.id)
      state.testimonies = state.testimonies.filter((p) => p.id !== action.payload.data.id)
      state.testimonies.splice(testimonyIndex, 0, action.payload.data)
