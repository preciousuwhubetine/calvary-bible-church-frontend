...
export default createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(index.pending, (state) => {
      state.loading = true;
      state.prayer_requests = [];
    })

    builder.addCase(index.fulfilled, (state, action) => {
      state.loading = false;
      state.prayer_requests = action.payload.data;
      state.error = null;
    })
    ...
    builder.addCase(create.fulfilled, (state, action) => {
      ...
      state.prayer_requests.push(action.payload.data);
    ...
    builder.addCase(show.fulfilled, (state, action) => {
      ...
      state.prayer_request = action.payload.data;
    ...
    builder.addCase(update.fulfilled, (state, action) => {
      ...
      state.prayer_request = action.payload.data;
      const prayer_requestIndex = state.prayer_requests.findIndex((p) => p.id === action.payload.data.id)
      state.prayer_requests = state.prayer_requests.filter((p) => p.id !== action.payload.data.id)
      state.prayer_requests.splice(prayer_requestIndex, 0, action.payload.data)
