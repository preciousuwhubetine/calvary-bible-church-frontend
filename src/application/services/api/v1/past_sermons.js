...
export default createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(index.fulfilled, (state, action) => {
      state.loading = false;
      state.past_sermons = action.payload.data;
      state.error = null;
    })
    ...
    builder.addCase(create.fulfilled, (state, action) => {
      ...
      state.past_sermons.push(action.payload.data);
    ...
    builder.addCase(show.fulfilled, (state, action) => {
      ...
      state.past_sermon = action.payload.data;
    ...
    builder.addCase(update.fulfilled, (state, action) => {
      ...
      state.past_sermon = action.payload.data;
      const past_sermonIndex = state.past_sermons.findIndex((p) => p.id === action.payload.data.id)
      state.past_sermons = state.past_sermons.filter((p) => p.id !== action.payload.data.id)
      state.past_sermons.splice(past_sermonIndex, 0, action.payload.data)
