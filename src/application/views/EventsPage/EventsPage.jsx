    ...
    <div className={styles['EventsPage']}>
      <section className={styles['EventsPageHero']}>
        <div className={styles['EventsPageHeroContent']}>
          ...
          <img src={Array.from(events).sort((a, b) => new Date(b.start_date) - new Date(a.start_date))[0]?.cover_image} />
        </div>
      </section>
        ...
        <ul>
          {
            events.length === 0 ? null : (
              Array.from(events).sort((a, b) => new Date(b.start_date) - new Date(a.start_date)).map((event) => (
                <li key={event.id}>
