    ...
    <div className={styles['GivePage']}>
      ...
      <section className={styles['GivePageAccounts']}>
        <div className={styles['GivePageAccountsToggle']}>
          <div className={styles['GivePageAccountsToggleIndicator']} />

          <button className={`${styles['GivePageAccountsToggleButtonActive']} ${styles['GivePageAccountsToggleButton']}`}>
            Naira accounts
          </button>

          <button className={`${styles['GivePageAccountsToggleButton']}`}>
            ...
            <div>
              ...
              <button>
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                  <path d="M8.94922 16.4044C8.94922 12.1872 8.94922 10.0771 10.26 8.76782C11.5693 7.45703 13.6794 7.45703 17.8966 7.45703H22.3703C26.5875 7.45703 28.6976 7.45703 30.0069 8.76782C31.3176 10.0771 31.3176 12.1872 31.3176 16.4044V23.8605C31.3176 28.0777 31.3176 30.1878 30.0069 31.4971C28.6976 32.8079 26.5875 32.8079 22.3703 32.8079H17.8966C13.6794 32.8079 11.5693 32.8079 10.26 31.4971C8.94922 30.1878 8.94922 28.0777 8.94922 23.8605V16.4044Z" stroke="black" stroke-width="1.34211"/>
                  <path d="M8.94829 28.3333C7.7618 28.3333 6.6239 27.862 5.78492 27.023C4.94594 26.184 4.47461 25.0461 4.47461 23.8596V14.9122C4.47461 9.28883 4.47461 6.47637 6.22233 4.73014C7.97005 2.98391 10.781 2.98242 16.4044 2.98242H22.3693C23.5558 2.98242 24.6937 3.45376 25.5327 4.29273C26.3717 5.13171 26.843 6.26961 26.843 7.45611" stroke="black" stroke-width="1.34211"/>
                </svg>
              </button>
            </div>
          </li>
