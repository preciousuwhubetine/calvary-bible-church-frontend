    ...
    <div className={styles['HomePage']}>
      ...
      <section className={styles['HomePageHero']}>
        {
          !heroSectionVideoLoaded && (
            <img fetchPriority="high" className={styles['HomePageHeroFallbackImage']} src="/homepage-hero-section-fallback-image.jpg" alt="" />
          )
        }
        <video
          autoPlay
      ...
      <section className={styles['HomePageGrayBackgroundSection']}>
        ...
        <div className={styles['HomePageGrayRotatedBackground']}>
          <img loading="lazy" className={styles['HomePageGraybackgroundSectionImage']} src="/icon.png" />
        </div>

        <section className={styles['HomePageSellingPoints']}>
          <ul>
            <li>
              <img loading="lazy" alt="" src="/homepage-bible-centered-teaching.jpg" />
            ...
            <li>
              <img loading="lazy" alt="" src="/homepage-loving-community.jpg" />
            ...
            <li>
              <img loading="lazy" alt="" src="/homepage-impactful-outreach.jpg" />
              <svg xmlns="http://www.w3.org/2000/svg" width="98" height="98" viewBox="0 0 98 98" fill="none">
...

        {
          past_sermons.length > 0 && (
            <section className={styles['HomePageLatestSermon']}>
              ...
              <div>
                <img loading="lazy" src={past_sermons[0].cover_image} alt="Latest Sermon" />
      ...
      <section className={styles['HomePageAddress']}>
        <div>
          ...
          <img loading="lazy" src="/homepage-address-section-map-image.png" alt="" />
        </div>
      </section>
                ...
                <ul data-current-child={0} ref={eventsContainerRef}>
                  {
                    Array.from(events).sort((a, b) => new Date(a.start_date) - new Date(b.start_date)).map((event, index) => (
                      <li key={index}>
                        <img loading="lazy" src={event.cover_image} alt={event.title} />
      ...
      <section className={styles['HomePageSneakPeek']}>
        ...
        <ul ref={sneakPeekListRef}>
          <li>
            <img loading="lazy" src="/sneak-peek-image-1.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-2.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-3.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-4.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-5.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-6.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-7.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-8.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-9.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-10.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-11.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-12.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-13.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-14.jpg" />
          </li>
          <li>
            <img loading="lazy" src="/sneak-peek-image-15.jpg" />
          </li>
        </ul>
      </section>
      ...
      <section className={styles['HomePageLeadership']}>
        ...
        <div className={styles['HomePageLeadershipContent']}>
          ...
          <img loading="lazy" src="/homepage-leadership-overseers-image.jpg" />
        </div>
      </section>
      ...
      <section className={styles['HomePageFeedback']}>
        <img loading="lazy" src="/homepage-feedback-section-bg.jpg" />
